				...
				<div className="flex flex-wrap gap-6 mt-6">
					...
					<Card className="bg-primary/6 rounded-lg shadow-sm border border-primary/50 py-5 px-3 flex flex-row  justify-center items-center text-center ">
						<div className="flex flex-col justify-center items-center text-center border-r border-foreground/40 px-12">
							<CardTitle className="text-3xl font-bold mt-2 text-[#249B00]">10</CardTitle>
							<CardDescription className="text-sm font-medium text-gray-500">Open</CardDescription>
						</div>

						<div className="flex flex-col justify-center items-center text-center border-r border-foreground/40 px-12">
							<CardTitle className="text-3xl font-bold mt-2 text-[#8B1A10]">32</CardTitle>
					...
					<div className="w-full px-1">
						<CardHeader className="flex flex-row items-center justify-between p-0 mb-4">
							...
							<div className="flex items-center space-x-2">
								...
								<Select>
									<SelectTrigger className="w-[300px] rounded-sm bg-foreground/6">
